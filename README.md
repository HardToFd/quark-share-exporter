...
- The custom `quarklink` Agent has no server-provided default upload directory. Local uploads therefore require an explicit root-directory choice or target directory FID; the application never silently substitutes the root.
